...
function Cv({ values, skills, languages, educations, experiences }) {
  // import images
  ...
  return (
    <div className="cv-container">
      <div className="left-side">
        <img src={profilePic} alt="blank profile" className='profile-img'/>
          ...
          <h1>Education</h1>
            <div>
              {educations.map((education, index) => (
                <EducationInfo key={index} startDate={education.eduStartDate} endDate={education.eduEndDate} degree={education.degree} school={education.school}/>
              ))}
            </div>
        </div>
        <div className='section'>
        ...
        <div className='experience'>
          ...
          <div>
              {experiences.map((experience, index) => (
                <ExperienceInfo key={index} startDate={experience.expStartDate} endDate={experience.expEndDate} companyName={experience.company} position={experience.position} location={experience.compLocation} description={experience.description}/>
              ))}
            </div>
        </div>
      </div>
